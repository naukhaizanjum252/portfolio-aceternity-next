...
export const PinContainer = ({
  ...
  return (
    <Link
      className={cn(
        "relative group/pin z-50 h-40 cursor-pointer w-40 overflow-hidden", // Add overflow-hidden here
        containerClassName
      )}
      target="_blank"
    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 top-1/2 p-4 flex justify-start items-start rounded-[3rem] shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-black border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden "
        >
